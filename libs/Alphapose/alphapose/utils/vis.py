# modifed from https://github.com/MVIG-SJTU/AlphaPose/blob/master/alphapose/utils/vis.py 
# by baiqianyi(863119860@qq.com)
...
def vis_frame_smpl(frame, im_res, smpl_output, opt, vis_thres):
    ...
    for n_human, human in enumerate(im_res):
        kp_preds = human['keypoints']
        kp_scores = human['kp_score']
